...
| ----------------------- | ----------: | ---------: | ---------: | ---------: | ----------: | ------: |
| JavaScript (V8 JIT)     | **16.8 ms** |     494 ms | **106 ms** | **129 ms** |  **138 ms** |   1.00x |
| BareScript              |      496 ms | **448 ms** |     124 ms |     586 ms |      269 ms |   3.08x |
| JavaScript (V8 jitless) |      811 ms |     954 ms |     169 ms |     735 ms |      337 ms |   4.60x |
| Python                  |      903 ms |     994 ms |     299 ms |     775 ms |      407 ms |   5.57x |
| Lua                     |      589 ms |     956 ms |     1.27 s |     464 ms |      612 ms |   6.64x |
| Ruby                    |      1.12 s |     1.01 s |     503 ms |     1.07 s |      1.02 s |   8.31x |
| Perl                    |      2.05 s |     1.16 s |     4.46 s |     2.80 s |      990 ms |  17.95x |

Only V8's JIT is faster overall, and BareScript beats it on the regex test. It leads every
interpreter on the regex, JSON, and n-body tests, and trails Lua 1.3x on pathfinding, where every
...
| ------------------- | ------: | -------: |
| Lua                 |  2.5 ms |   1.7 MB |
| BareScript          |  2.9 ms |   2.6 MB |
| Perl                |  4.5 ms |   4.3 MB |
| Python              | 16.0 ms |  14.6 MB |
| JavaScript (V8 JIT) | 25.7 ms |  38.3 MB |
...
| BareScript (C)   |     14.0 s |      215 ms |     804 ms |      152 ms |     4.0 ms | **180 s** |   2.47x |
| Python (CPython) |     45.9 s |             |            |      204 ms |    10.4 ms |           |   4.22x |
| BareScript (JS)  |      259 s |      642 ms |     2.08 s |      1.67 s |    41.5 ms |   1,580 s |  19.53x |
| BareScript (PyC) |      112 s |      620 ms |     7.02 s |      1.03 s |    51.0 ms |   7,220 s |  25.10x |
| BareScript (Py)  |    3,425 s |      5.26 s |     20.7 s |      13.9 s |     368 ms |   9,440 s | 175.34x |
...
allocating nested objects 6.7x faster. Native C runs `mandelbrot` in 0.79 ms, 18x ahead.
...
| ----------------------- | ---------: | ---------: | -----------: | -----------: | ----------: | ----------: | ------: |
| Lua                     | **1.7 MB** | **1.8 MB** |     138.2 MB |     201.4 MB |     39.4 MB | **35.1 MB** |   1.00x |
| BareScript              |     2.6 MB |     3.0 MB | **101.6 MB** | **120.3 MB** | **32.4 MB** |     69.6 MB |   1.11x |
| Perl                    |     4.3 MB |     6.8 MB |     136.8 MB |     218.0 MB |    113.3 MB |     86.8 MB |   2.05x |
| Python                  |    14.6 MB |    15.3 MB |     107.1 MB |     162.2 MB |     56.5 MB |     73.8 MB |   2.29x |
| Ruby                    |    28.1 MB |    28.2 MB |     189.2 MB |     206.5 MB |     43.0 MB |    105.4 MB |   3.27x |
| JavaScript (V8 JIT)     |    38.3 MB |    44.7 MB |     363.2 MB |     159.4 MB |     69.7 MB |    194.0 MB |   4.77x |
| JavaScript (V8 jitless) |    37.7 MB |    40.7 MB |     357.2 MB |     181.5 MB |     86.2 MB |    196.0 MB |   4.96x |
